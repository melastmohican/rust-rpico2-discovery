//! # SSD1315 OLED Text & Graphics Example
//!
//! This example demonstrates drawing text and shapes on a 128x64 SSD1315 display over I2C0.
//!
//! ## Hardware
//!
//! - **Board:** Raspberry Pi Pico 2
//! - **Display:** SSD1315 128x64 OLED (I2C)
//!
//! ## Wiring
//!
//! ```
