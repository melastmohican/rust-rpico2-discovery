...
curl -L -o 43439A0.bin "$BASE_URL/43439A0.bin"

echo "Downloading Country Lookup Matrix (CLM)..."
curl -L -o 43439A0_clm.bin "$BASE_URL/43439A0_clm.bin"

echo "Downloading NVRAM settings..."
curl -L -o nvram_rp2040.bin "$BASE_URL/nvram_rp2040.bin"

echo "Downloading Bluetooth firmware (BTFW)..."
curl -L -o 43439A0_btfw.bin "$BASE_URL/43439A0_btfw.bin"

echo "Done! All firmware files downloaded from official source."
